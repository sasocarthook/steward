...
class RunCommandTest extends TestCase
{
    ...
    public function testShouldStopIfNoTestcasesWereFoundInTheFiles()
    {
        ...
        // Mock createFromFiles() to return empty processSet, and also ensure product_order are passed to the processSetCreator
        ...
        $this->assertContains('No testcases matched given product_order, exiting.', $this->tester->getDisplay());
        $this->assertSame(1, $this->tester->getStatusCode());
    }
