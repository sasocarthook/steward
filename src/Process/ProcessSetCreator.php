...
class ProcessSetCreator
{
    ...
    /**
     * Create ProcessSet from given files, optionally filtering by given $product_order and $excludeGroups
     *
     * @param Finder $files
    ...
    protected function buildProcess($fileName, array $phpunitArgs = [])
    {
        ...
        $processBuilder
            ...
            ->setEnv('COUNTRY', $this->input->getOption(RunCommand::OPTION_COUNTRY))
            ->setEnv('PAYMENT_PROCESSOR', $this->input->getOption(RunCommand::PAYMENT_PROCESSOR))
            ->setEnv('DISCOUNT', $this->input->getOption(RunCommand::OPTION_DISCOUNT))
            ->setEnv('SLACK', $this->input->getOption(RunCommand::OPTION_SLACK))
            ->setEnv('STATISTICS', $this->input->getOption(RunCommand::OPTION_STATISTICS))
    ...
    /**
     * Get array of product_order that cause this class to be excluded.
     *
