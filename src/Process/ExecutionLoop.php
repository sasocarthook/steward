...
class ExecutionLoop
{
    ...
    protected function dequeueDependentProcesses()
    {
    ...
    protected function dequeueParallelProcesses()
    {
        $queued = $this->processSet->get(ProcessWrapper::PROCESS_STATUS_QUEUED);
    ...
    protected function printExecutionLoopStatus(array $statusesCount)
    {
        $resultsInfo = [];
        $resultsCount = $this->processSet->countResults();
    ...
    protected function failDependants(string $testClass)
    {
    ...
    protected function parallelLimitReached()
    {
